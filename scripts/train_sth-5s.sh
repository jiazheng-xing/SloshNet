python run.py -c ./exp/ssv2/5w-5s --query_per_class 5 --shot 5 --way 5  \
 ...
 --num_gpus 4 --opt sgd --save_freq 8000 --print_freq 1000  --training_iterations 80010 --temp_set 1 2  --weight_decay 5e-5 --steps 0 6 8 9 --LRS 1 0.5 0.1 0.01  \
